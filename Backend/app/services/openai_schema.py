...
EXTRACTION_SCHEMA = {
    ...
    "$defs": {
        ...
        "EventExtraction": _object(
            ["ref", "thingRef", "title", "eventType", "rawText", "occurredAt", "note", "metadata", "confidence"],
            {
        ...
        "EventMetadataExtraction": _object(
            ["key", "valueKind", "stringValue", "numberValue", "dateValue", "boolValue", "unit", "sourceText"],
            {
                "key": _enum([
                    "mileage",
                    "amount",
        ...
        "RuleExtraction": _object(
            ["ref", "thingRef", "title", "ruleType", "rawText", "reason", "startsAt", "expiresAt", "isActiveOnCreatedDate", "confidence"],
            {
                "ref": {"type": "string", "pattern": "^rule_[0-9]+$"},
                "thingRef": _nullable_string("^thing_[0-9]+$"),
                "title": {"type": "string"},
                "ruleType": _enum(["restriction", "reminder", "preference", "deadline", "waiting_period", "other"]),
                "rawText": {"type": "string"},
        ...
        "DateExtraction": _object(
            ["ref", "sourceText", "resolved", "dateRole", "ownerRef", "ownerField", "confidence"],
            {
                ...
                "dateRole": _enum(["event_occurred_at", "rule_starts_at", "rule_expires_at", "note_date", "query_target", "duration", "unknown"]),
                "ownerRef": _nullable_string("^(event|rule|note|query)_[0-9]+$"),
                "ownerField": _enum(["occurredAt", "startsAt", "expiresAt", "noteDate", "queryTarget", "duration", "context", "unknown"]),
                "confidence": {"type": "number", "minimum": 0, "maximum": 1},
            },
        ),
        ...
        "ExtractionError": _object(
            ...
            {
                "code": _enum(["no_extractable_content", "date_unresolved", "thing_unresolved", "rule_unresolved", "unsupported_request", "schema_uncertain"]),
                "message": {"type": "string"},
