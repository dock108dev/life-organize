...
enum LifeOrganizeSchemaV1: VersionedSchema {
    ...
    static var models: [any PersistentModel.Type] {
        [
            LifeOrganizeSchemaV1.ChatMessage.self,
            LifeOrganizeSchemaV1.ExtractionAttempt.self,
            LifeOrganizeSchemaV1.EntityLink.self,
